    ...
    <div className="space-y-6 pb-16 max-w-3xl">
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <Label>Sizes <span className="normal-case text-teal-900/40">(comma-separated)</span></Label>
            <input
              type="text"
              name="sizes"
          ...
          <div>
            <Label>Colors <span className="normal-case text-teal-900/40">(comma-separated)</span></Label>
            <input
              type="text"
              name="colors"
